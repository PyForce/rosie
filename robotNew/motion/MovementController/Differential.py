...
class DifferentialDriveRobotLocation:
    """
    Structure containing the cartesian coordinates of a robotNew
...
class DifferentialDriveRobotParameters:
    """
    Structure containing parameters for a differential drive mobile robotNew
...
class DifferentialDriveRobotSpeed:
    """
    Structure containing speeds of a robotNew
