...
from robotNew.motion.MovementController.Differential import DifferentialDriveRobotLocation, DifferentialDriveRobotSpeed
...
class DifferentialDriveRobotState:
    """
    Class to represent the state of a differential drive mobile robotNew

    @param elapsed_time: elapsed time since last state update
    @param battery_voltage: voltage of the battery of the robotNew
    ...
    @param reference_speed: speed of reference of the robotNew
    @param location: location of the robotNew
    @param global_location: location of the robotNew (global)
    @param reference_location: location of reference of the robotNew
    ...
    def update(self, location, global_location, reference_location, reference_speed, x_speed_ref, y_speed_ref,
        ...
        """
        Method to update the state of the robotNew
...
class DifferentialDriveTrajectoryPlanner:
    """
    Abstract class to plan trajectories for a differential drive mobile robotNew
    ...
    def get_next_point(self):
        ...
        the reference robotNew in the current point
        """
        pass
