...
from robotNew.motion.TrajectoryPlanner.Differential import DifferentialDriveTrajectoryPlanner
...
class LinearTrajectoryPlanner(DifferentialDriveTrajectoryPlanner):
    """
    Class to plan trajectories for a differential drive mobile robotNew using lineal interpolation
