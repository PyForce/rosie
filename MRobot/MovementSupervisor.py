...
class FileLoggerMovementSupervisor(DifferentialDriveMovementSupervisor):
    ...
    def movement_end(self):
        ...
        thread.start_new_thread(file_writer_thread,
...
def file_writer_thread(file_name, updates_done, x_position_vector, y_position_vector, z_position_vector, x_speed_vector,
                       y_speed_vector, z_speed_vector, x_ref_vector, y_ref_vector, z_ref_vector, x_ref_speed_vector,
                       ...
                       wheel_distance, constant_b, constant_k1, constant_k2, constant_kc, constant_ki, constant_kd):
    time_vector[0] = 0.
