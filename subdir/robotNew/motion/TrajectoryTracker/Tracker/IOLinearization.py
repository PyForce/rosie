...
from robotNew.motion.TrajectoryTracker.Differential import DifferentialDriveTrajectoryTracker
...
class IOLinearizationTrajectoryTracker(DifferentialDriveTrajectoryTracker):
    """
    Class to make trajectory tracking of a differential drive mobile robotNew using IO Linearization Method
    ...
    def __init__(self, robot_parameters, smooth_flag=False):
        super(IOLinearizationTrajectoryTracker, self).__init__()
        self.robot_parameters = robot_parameters
        self.constant_k2 = robot_parameters.constant_k2
        self.constant_k1 = robot_parameters.constant_k1
        self.constant_b = robot_parameters.constant_b
