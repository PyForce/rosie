...
class Track:
    ...
    def generate_cubic(self, x_planning=None, y_planning=None, sample_time=None,
        ...
        self.xd_vector = list(range(n * intervals))
        self.yd_vector = list(range(n * intervals))
        self.zd_vector = list(range(n * intervals))

        self.xd_dot_vector = list(range(n * intervals))
        self.yd_dot_vector = list(range(n * intervals))
        self.zd_dot_vector = list(range(n * intervals))
    ...
    def generate_lineal(self, x_planning=None, y_planning=None, sample_time=None,
        ...
        self.xd_vector = list(range(max_count))
        self.yd_vector = list(range(max_count))
        self.zd_vector = list(range(max_count))

        self.xd_dot_vector = list(range(max_count))
        self.yd_dot_vector = list(range(max_count))
        self.zd_dot_vector = list(range(max_count))
    ...
    def generate_backward(self, x_planning=None, y_planning=None, sample_time=None,
        ...
        self.xd_vector = list(range(i_points))
        self.yd_vector = list(range(i_points))
        self.zd_vector = list(range(i_points))

        self.xd_dot_vector = list(range(i_points))
        self.yd_dot_vector = list(range(i_points))
        self.zd_dot_vector = list(range(i_points))
