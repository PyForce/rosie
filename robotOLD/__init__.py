...
#---- rOSi import ----
from robotOLD import load
load.load_global_settings()

from robotOLD import planner
from robotOLD import controller as Controller
...
class Master:
    ...
    def position(self, x=None, y=None, theta=None):
        """
        Get or set the position of the robotOLD
    ...
    def profile(self, p={}):
        """
        Get or set the profile of the robotOLD

        :param p: robotOLD's profiles to setup
        :type p: dict
        ...
        >>> master.profile()
        {'MOBILE_ROBOT': 'ROBOT', 'FILENAME': 'robotOLD.py'}
        """
        if p:
            pass
        #---- get profile ----
    ...
    def is_ended(self):
        """
        Get task status of the robotOLD.
    ...
    def end_current_task(self):
        """
        End current task of the robotOLD.
